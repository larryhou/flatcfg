...
| FIELD_TYPE | uint32 | string | string | enum.ItemRarity | bool | bool | date | date | enum.GoodsType | uint32 | enum.MallAchievingType | int32 | enum.MallItemTag | string | enum.MallSubscriptType | date | date | enum.GoodsType | uint32 | uint32 | uint32 | uint32 | 2 | 5 | enum.GoodsType | uint32 | uint32 | uint32 | 2 | 3 | date | date | uint32 | date | date | uint32 | enum.GoodsType | uint32 | uint32 | uint32 | 2 | 3 | date | date | uint32 | date | date | uint32 | uint32 | uint32 | uint32 | uint32 | uint32 | bool | uint32 | bool |
